    ...
    <div class="main-wrapper">
        ...
        <div class="content">
            ...
            <div class="container-fluid my-5 px-5">
                ...
                <p class="text-muted mb-4">Temukan e-book terbaik untuk meningkatkan wawasan dan keterampilanmu. Semua
                    bisa diunduh gratis!</p>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="card h-100 border-0 shadow-sm ebook-card hover-shadow">
                            <img src="https://my.skul.id/static/media/img_default_artikel_thumb.03a53a33.svg"
                                class="card-img-top" alt="Public Speaking">
                            <div class="card-body">
